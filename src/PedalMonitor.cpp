...
// コンストラクタ
PedalMonitor::PedalMonitor(midi::MidiInterface<midi::SerialMIDI<Adafruit_USBD_MIDI>>* midiInstance, const int* pins, int* PedalControlNumbers, int SwitchesNumber, unsigned long debounceDelay) 
...
void PedalMonitor::sendSwitchesMIDI(int switchIndex, int state){
